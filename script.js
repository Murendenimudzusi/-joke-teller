...
// Disabel and Enable Button
// function toggleButton() {
//     button.disabled = !button.enabled;
// };

// API Key
// 90f707dcf086422e9f17690792023953

// Pasing Joke to VoiceRSS API
function tellMe(joke) {
    // console.log('tell me:', joke);
    VoiceRSS.speech({
        key: '90f707dcf086422e9f17690792023953',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming,Dark?blacklistFlags=nsfw,religious,political,racist,sexist';
    try {
